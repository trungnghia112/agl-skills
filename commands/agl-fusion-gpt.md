---
description: Fusion panel of Opus 4.8 + GPT in parallel, judged + adversarially verified by Opus 4.8 (opus-gpt)
...
Run the **fusion** pipeline, forcing the `opus-gpt` panel: Opus 4.8
...
seeing the other's work → Opus 4.8 judges both, **adversarially verifies its own
