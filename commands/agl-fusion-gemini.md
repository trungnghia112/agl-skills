---
description: Fusion panel of Opus + Gemini in parallel, judged + adversarially verified by Opus (opus-gemini)
...
Run the **fusion** pipeline, forcing the `opus-gemini` panel: Opus
...
never abort because one CLI failed. Opus always judges and writes the final
answer.
