...
#
# - <slug>           : the panel slug actually run (e.g. opus-gpt-gemini)
...
#                      "gpt=/tmp/fusion_codex_out.md", "gemini=/tmp/fusion_gemini_out.md")
#
# Optional env:
#   FUSION_PANEL_NOTE  degradation note (e.g. "gemini dropped: agy empty -> opus-gpt")
