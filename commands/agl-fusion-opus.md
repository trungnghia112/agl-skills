...
question is about this project** (Step 2 — skip it for general/off-project questions), and
inject the **freshness guard** (Step 2) **only if the question is time-sensitive**
(latest version/price/release-status/law) — skip it for timeless questions. Both
